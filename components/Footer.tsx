    ...
    <footer className="py-12 px-6 border-t border-taupe-light bg-warm-white">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6 flex-wrap justify-center">
          <a href="/privacy" className="font-inter text-text-secondary text-sm hover:text-charcoal transition-colors">
            Privacy Policy
          </a>
          <a href="/terms" className="font-inter text-text-secondary text-sm hover:text-charcoal transition-colors">
            Terms
          </a>
          <a href="/support" className="font-inter text-text-secondary text-sm hover:text-charcoal transition-colors">
            Support
          </a>
          <a href="/about" className="font-inter text-text-secondary text-sm hover:text-charcoal transition-colors">
            About
          </a>
          <a
